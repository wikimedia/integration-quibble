...
def get_arg_parser():
    ...
    deps.add_argument(
        '--npm-install-ahead',
        action='store_true',
        help='In the BrowserTest stage, run "npm install" for the next '
        'project in the background while the tests for the current project '
        'run. By default the install runs right before the tests of each '
        'project.',
    )
